...
class RobertaForSequenceClassification(RobertaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.roberta = RobertaModel(config, add_pooling_layer=False)
        self.freeze_params(self.roberta)
...
class RobertaForTokenAttentionCLS(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class RobertaForDisentangledRepresentation(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class RobertaForTokenAttentionSparseCLS(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class RobertaForTokenAttentionSparseCLSJoint(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
