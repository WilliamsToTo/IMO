...
from models.modeling_bart import (
    ...
    BartForSequenceClassificationMultiClass,
    ...
    BartForTokenAttentionSparseCLSJointMultiClass_incremental,
)

from models.modeling_t5 import (
    T5ForSequenceClassificationMultiClass,
    T5ForTokenAttentionCLSMultiClass,
    T5ForDisentangledRepresentationMultiClass,
    T5ForTokenAttentionSparseCLSJointMultiClass
)

from models.modeling_bert import (
    BertForTokenAttentionSparseCLSJointMultiClass
)

from models.modeling_mbart import (
    MBartForSequenceClassificationMultiClass,
    MBartForTokenAttentionCLSMultiClass,
    MBartForDisentangledRepresentationMultiClass,
    MBartForTokenAttentionSparseCLSJointMultiClass
)
...
def parse_args():
    ...
    parser.add_argument(
        "--hidden_state_layer", type=int, default=12, help=(
...
def main():
    ...
    if "ChatYuan" in args.backbone_model:
        backbone_model = AutoModelForSeq2SeqLM.from_pretrained(args.backbone_model)
    else:
        backbone_model = AutoModel.from_pretrained(args.backbone_model)

    if args.model_class == "BartForSequenceClassificationMultiClass":
        model = BartForSequenceClassificationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "MBartForSequenceClassificationMultiClass":
        model = MBartForSequenceClassificationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
        tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path, src_lang="zh_CN", tgt_lang="zh_CN")
    elif args.model_class == "T5ForSequenceClassificationMultiClass":
        model = T5ForSequenceClassificationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "BartForTokenAttentionCLSMultiClass":
        model = BartForTokenAttentionCLSMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "MBartForTokenAttentionCLSMultiClass":
        model = MBartForTokenAttentionCLSMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        ...
        tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path, src_lang="zh_CN", tgt_lang="zh_CN")
    elif args.model_class == "T5ForTokenAttentionCLSMultiClass":
        model = T5ForTokenAttentionCLSMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "BartForDisentangledRepresentationMultiClass":
        model = BartForDisentangledRepresentationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "MBartForDisentangledRepresentationMultiClass":
        model = MBartForDisentangledRepresentationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        ...
        tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path, src_lang="zh_CN", tgt_lang="zh_CN")
    elif args.model_class == "T5ForDisentangledRepresentationMultiClass":
        model = T5ForDisentangledRepresentationMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "BartForTokenAttentionSparseCLSJointMultiClass":
        model = BartForTokenAttentionSparseCLSJointMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "BartForTokenAttentionSparseCLSJointMultiClass_incremental":
        model = BartForTokenAttentionSparseCLSJointMultiClass_incremental.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
    ...
    elif args.model_class == "T5ForTokenAttentionSparseCLSJointMultiClass":
        model = T5ForTokenAttentionSparseCLSJointMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "BertForTokenAttentionSparseCLSJointMultiClass":
        model = BertForTokenAttentionSparseCLSJointMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
        )
    elif args.model_class == "MBartForTokenAttentionSparseCLSJointMultiClass":
        model = MBartForTokenAttentionSparseCLSJointMultiClass.from_pretrained(
            args.model_name_or_path,
            from_tf=bool(".ckpt" in args.model_name_or_path),
            config=config,
            ignore_mismatched_sizes=args.ignore_mismatched_sizes,
    ...
    if args.only_evaluation:
        ...
        for step, batch in enumerate(tqdm(eval_dataloader, total=len(eval_dataloader)) ):
            if "bartzh" in args.model_name_or_path:
                batch.pop("token_type_ids")
            with torch.no_grad():
                outputs = model(**batch, output_hidden_states=True, hidden_state_layer=args.hidden_state_layer, backbone_model=backbone_model)
        ...
        for epoch in range(starting_epoch, args.num_train_epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                if "bart_large_chinese" in args.model_name_or_path:
                    batch.pop("token_type_ids")
